...
\citeauthor{velten:1939} later points out some particular flaws in \citeauthor{swanton:1909}’s transcription, having worked with a speaker of Tlingit from Klawock (\fm{Yeex̱aas} Lester Roberts):

\begin{quote}\small
Earlier material and Swanton’s transcription, as well as his grammatical analysis, are often inaccurate.
For example, he disregards pitch altogether; he fails to distinguish between the glottalized voiceless lateral spirant \fm{łʼ} and the corresponding affricate \fm{tłʼ}; and he uses a single symbol for the glottalized velar stop \fm{q̓} and the glottalized palatal and velar spirants \fm{x̓} and \fm{x̣̓}, which are all clearly distinguished in southern as well as northern Tlingit.
\sourceatright{\parencite[5]{velten:1939}}
\end{quote}
