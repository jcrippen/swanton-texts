...
Although the Tlingit story is often located by narrators at \fm{Áakʼw} Auke Lake near Juneau as is done in this narrative, there are a few placenames containing the name \fm{Tlʼanaxéedáḵw} which suggest that it may sometimes be situated in other locales.
...
\begingl
	...
	\glb	{} du waaḵ -dě {}
		ÿa- g- \rt[²]{shiᴸ} -μμL -ch //
	\glc	{}[\pr{PP} \xx{3h·pss} eye -\xx{all} {}]
		\xx{qual}- \xx{gcnj}- \rt[²]{reach·hand} -\xx{var} -\xx{rep} //
	\gld	{} her eye -to {}
		\rlap{\xx{gcnj}.\xx{hab}.reach·hand} {} {} {} {} //
	\glft	‘He kept reaching up toward her eyes.’
		//
\endgl
\xe

\FIXME{Discuss \fm{ÿa-} in the verb in (\lastx) and use of \fm{g}-conjugation class.}

\ex\label{ex:94-19-pushing-away}%
\exmn{292.10}%
\begingl
	\glpreamble	Tc!uʟe′ duwuts!ag̣ā′ỵītc yūt akułtā′qᴀtc!. //
	\glpreamble	Chʼu tle du wootsaag̱áaÿich yóot akooltaaḵch. //
	\gla	Chʼu tle
		{} du \rlap{wootsaag̱áaÿich} @ {} @ {} @ {} @ {} @ {} {}
		{} \rlap{yóot} @ {} {}
		\rlap{akooltaaḵch.} @ {} @ {} @ {} @ {} @ {} @ {} //
	\glb	chʼu tle
		{} du wu- \rt[²]{tsaḵ} -μμL -ǎa -ǐ -ch {}
		{} yú -t {}
		a- ka- u- l- \rt[²]{taḵ} -μμL -ch //
	\glc	just then
		{}[\pr{PP} \xx{3h·pss} \xx{unkn}- \rt[²]{poke}
			-\xx{var} -\xx{nmz} -\xx{pss} -\xx{erg} {}]
		{}[\pr{PP} \xx{dist} -\xx{pnct} {}]
		\xx{arg}- \xx{qual}- \xx{zpfv}- \xx{appl}- \rt[²]{poke} -\xx{var} -\xx{rep} //
	\gld	just then
		{} her \rlap{cane} {} {} {} {} -with {}
		{} away -at {}
		\rlap{3>3.\xx{zcnj}.\xx{hab}.\xx{appl}.poke} {} {} {} {} {} {} //
	\glft	‘Just then she kept pushing him away with her cane.’
		//
\endgl
\xe
