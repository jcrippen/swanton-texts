...
In his comparative analysis of Northwest Coast narratives, \citeauthor{boas:1916} mentions only the two versions of this story recorded by \citeauthor{swanton:1909} \parencite[758]{boas:1916}.
...
He does not mention any stories from other cultures that bear any close resemblance to the \fm{Shaakanaaÿí} story.
A review of the narrative collections from Haida \parencites{boas:1895}{swanton:1905a}{swanton:1905b}{swanton:1908a} and Tsimshianic consultants \parencites{boas:1895}{boas:1912a}{boas:1916}{barbeau-beynon:1987a}{barbeau-beynon:1987b} has turned up no similar stories.

\citeauthor{teit:1919} gives the “Story of Cā′kinā” from an unspecified Tahltan consultant which he claims is a version of the \fm{Shaakanaaÿí} story \parencite[244–246]{teit:1919}.
The plot of this narrative has been melded with the otherwise independent “Beaver and Porcupine” story \parencites[cf.][446–448]{swanton:1908a}[724–727]{boas:1916}[496, 621–622]{mcclellan-cruikshank:2007c}, but the personal name and various details match the recorded Tlingit versions.
\citeauthor{teit:1917} also suggests that the Kaska story “The Fog-Man” \parencite[466–467]{teit:1917} is another version of \fm{Shaakanaaÿí} but this appears to be only tangentially related, primarily via the “Beaver and Porcupine” story.

\begin{figure}
\centerfloat
\includegraphics[height=35em, keepaspectratio=true]{figures/swanton-1908-431-109-model.png}
\caption{Model totem pole of \textit{Shaakanaaÿí}, Hoonah, circa 1904 \parencite[431 fig.\ 109]{swanton:1908}}
\label{fig:92-mountain-dweller-swanton-pole}
\end{figure}

\begin{figure}
\centerfloat
\includegraphics[width=\textwidth, keepaspectratio=true]{figures/krause-1885-132-pole-clean.png}
\caption{Totem pole of \textit{Shaakanaaÿí} from Hoonah, 1881 \parencite[132]{krause:1885}}
\label{fig:92-mountain-dweller-krause-pole}
\end{figure}

The figure of \fm{Shaakanaaÿí} appeared on a totem pole in Hoonah which no longer exists.
\citeauthor{swanton:1908} offers a photograph of a model for the pole (fig.\ \ref{fig:92-mountain-dweller-swanton-pole}) which was said to be erected for a \fm{Chookaneidí} clan leader called ”Dāx̣ug̣ē′t” which is probably \fm{Daaxoogeit} \parencite[431 fig.\ 109]{swanton:1908}.
He describes this model pole as having \fm{Shaakanaaÿí} at the base surmounted by his dog and an eagle.
...
This could imply that the sisters who married him were of the Raven moiety, fitting with the Chilkat {G̱aanax̱teidí} clan’s use of \fm{Ḵákw Tláa} which is discussed further below.

\citeauthor{krause:1885} provides a drawing (fig.\ \ref{fig:92-mountain-dweller-krause-pole}) of the original totem pole located in Hoonah which shows much more detail and complexity than the model photographed by \citeauthor{swanton:1909} \parencites[132]{krause:1885}[94]{krause:1956}.%
\footnote{Although \citeauthor{krause:1885} says in his caption “nach einer Photographie”, i.e.\ ‘after a photograph’, relative there is no such photograph known at present.
The front view certainly reflects the traditional formline style in contrast with the side view and so is plausibly copied from a photograph.}
At the base of this pole is a caniform animal labelled “kētl, Hund” which must be \fm{keitl} ‘dog’.
Behind and above the dog is “schā-kā-nāri, mythische Person” which is clearly \fm{Shaakanaaÿí} who is indeed a mythical person.
Above this is an animal labelled “ssāch, Robbe” that seems most likely to be \fm{sʼaax̱} ‘groundhog’ (a.k.a.\ hoary marmot, \textit{Marmota caligata}) rather than \fm{tsaa} ‘seal’ (“Robbe”).
“kī-dschūk, Habicht [hawk]” which is \fm{gijook} \~\ \fm{kijook} (perhaps from \fm{kích} ‘wing’ + \fm{\rt{yuʼk}} ‘shake’).%
\footnote{The identity of \fm{gijook} \~\ \fm{kijook} is uncertain but it is some kind of raptor.
Some speakers say it refers to a golden eagle (\textit{Aquila chrysaetos} L.)\ and others to a kind of hawk, i.e.\ \textit{Accipitrinae} or \textit{Buteoninae} \parencites[127]{boas:1917}[257]{krause:1956}[44]{olson:1967}[47]{de-laguna:1972}[172–173]{mcclellan:1975a}[466–467]{mcclellan:1975b}[28]{naish-story:1976}[33, 255, 441–442, 458]{emmons:1991}[\textsc{m}·137]{leer:2001}.
Its is likely that the meaning varies between communities \parencite[173]{mcclellan:1975a}.}
The identity of the small figure on the breast of the \fm{gijook} is unknown and there is not enough detail to unambiguously identify it from its appearance.

Comparing \citeauthor{swanton:1909}’s model (fig.\ \ref{fig:92-mountain-dweller-swanton-pole}), \citeauthor{krause:1885}’s drawing (fig.\ \ref{fig:92-mountain-dweller-krause-pole}), and both descriptions, we certainly have the common appearance of \fm{gijook} and \fm{Shaakanaaÿí}.
The model has a small figure atop \fm{Shaakanaaÿí} which is supposed to be his dog but which would better match the groundhog in the drawing.
The model then lacks the dog and the unidentified figure of the drawing.
There is no dog, groundhog, or \fm{gijook} mentioned in any recorded versions of the \fm{Shaakanaaÿí} story, so it is unclear how these are related.

\citeauthor{krause:1885} later gives \fm{Shaakanaaÿí} a unique alternative name “schkā-tā-hīn-āri” \parencites[380]{krause:1885}[251]{krause:1956} which seems to be \fm{Shg̱adaahéen Aaÿí} ‘One of \fm{Shg̱adaahéen}’.
This is plausibly be a reference to \fm{Shg̱adaayi Héen} ‘River that Flows Itself Down’ i.e.\ Waterfall Creek north of Cape Fairweather \parencite[25 \#289, 40 \#31]{thornton:2012}.
Although this location is within the area traditionally claimed by the \fm{Tʼaḵdeintaan} clan of Hoonah \parencite[45, 56–57, 123, 135]{goldschmidt-haas:1998}, there are no written records that explain why \fm{Shaakanaaÿí} should be connected to this place or to any other location with a similar name.
...
Apparently because of this association with woodworking, \citeauthor{swanton:1908} speculates: “Perhaps he [\fm{Shaakanaaÿí}] is to be identified with Tᴀxgwᴀ′s [\fm{Taxgwás}]” \parencite[460]{swanton:1908}.
Vanishingly little has been recorded about \fm{Taxgwás}; \citeauthor{swanton:1909}’s preceding discussion is repeated here for reference.
His interpreter is \fm{Daalwoolsʼéesʼ} John Cameron \parencite[130]{jones:2017} who presumably helped \citeauthor{swanton:1909} transcribe the narrative of this chapter.

\begin{quote}\small
Tᴀxgwᴀ′s was a being who made canoes, and so corresponded to the Haida canoe maker Wᴀtg̣adagā′ñ.
One who was destined to become a good canoe maker heard him chopping very fast, woodpecker-like.
Then the man had to throw off his coat and shirt and follow the sound, and he had to wash his face and head in the first lake he came to.
My interpreter told me that his father once heard the noise Tᴀxgwᴀ′s makes, and came upon a tree with fine chips all around the bottom, but he forgot to take off his coat and so missed seeing the being himself.
\sourceatright{\parencite[460]{swanton:1908}}
\end{quote}

The name \fm{Taxgwás} also appears in a song by \fm{Sakwéitʼ} of the \fm{Lʼeeneidí} clan \parencite[410–411 \#82]{swanton:1909} but there is not much to be gleaned from this context.
\citeauthor{mcclellan:1975b} also mentions a mythical being she transcribes as \orth{tʼaqwᴀts}.
Her transcription implies something like \fm{tʼaḵwáts} but her transcriptions are somewhat unreliable and given her description this is plausibly the same as \citeauthor{swanton:1908}’s \orth{Tᴀxgwᴀ′s}.
...
It is unclear if \fm{Naatsilanéi} is in any way connected to \fm{Taxgwás}, but the orthographic representation by \fm{Ḵeixwnéi} Nora Marks Dauenhauer at least gives us a good idea of how the name is pronounced.
\FIXME{No obvious details about \fm{Taxgwás} on this recording.
Discuss possible connection with \fm{Naatsilanéi} as he is a carver.}
\FIXME{Any further evidence about \fm{Taxgwás}?}

In his discussion of \fm{Taxgwás} above, \citeauthor{swanton:1908} claims that the Tlingit figure corresponds to the Haida mythical being of “Wᴀtg̣adagā′ñ” that \citeauthor{swanton:1909} generally labels “Master Carpenter” in English \parencite[30]{swanton:1905b}.
...
None of these stories bears any resemblance to the story of \fm{Shaakanaaÿí} so \citeauthor{swanton:1908}’s suggested connection with this Haida figure is tenuous.
...
\caption{Inside \textit{Yáay Hít} ‘Whale House’, Klukwan, 1885 (Alaska State Library ASL-P87-0013)}
...
Although he does not mention his consultant, part of \citeauthor{olson:1967}’s fieldwork was in Klukwan so we can presume this came from one of his \fm{G̱aanax̱teidí} consultants (he was adopted into this clan) during his visits in the 1930s.
...
But \citeauthor{swanton:1909}’s transcription clearly has \orth{cakᴀnā′ỵītc ᴀcakāwayū′g} with \orth{ᴀ} at the beginning of the verb word suggesting an initial \fm{a-}.
...
\citeauthor{swanton:1909}’s gloss “they wanted to bring them” in (\lastx) and his transcription \orth{hᴀs aỵahê′} suggest the verb \fm{yéi asaawahaa} \~\ \fm{yéi aseiwahaa} (\fm{g̱}; \fm{-eμH} state) ‘s/he was willing for it, wanted it to happen’ which has an imperfective state form \fm{yéi asaÿahéi} ‘s/he is willing for it, wants it to happen’ \parencite[01/44]{leer:1973}.
