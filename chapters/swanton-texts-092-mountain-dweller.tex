...
\begingl
	...
	\glpreamble	«\!Daa sákwshí ÿee tushoowanáa?\!» //
	\gla	«\!Daa \rlap{sákwshí} @ {}
		ÿee @ \rlap{tushoowanáa?\!»} @ {} @ {} @ {} @ {} @ {} //
	\glb	\pqp{}daa sá =gushí
		ÿee= tu- shu- wu- i- \rt[²]{na(ʼÿ)} -μμH //
	\glc	\pqp{}what \xx{q} =\xx{dub}
		\xx{2pl·o}= mind- end- \xx{pfv}- \xx{stv}- \rt[²]{send} -\xx{var} //
	\gld	\pqp{}what \xx{q} \•perhaps
		you·\xx{pl} \rlap{mind.end.\xx{ncnj}.\xx{pfv}.command} {} {} {} {} {} //
	\glft	‘“What perhaps drove you?”’
		//
\endgl
\xe
