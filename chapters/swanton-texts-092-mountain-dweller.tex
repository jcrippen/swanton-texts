...
\begingl
	...
	\glpreamble	Aadáx̱ áyú tléil gwáayú l a ÿikdaa.át. //
	\gla	 //
	\glb	 //
	\glc	 //
	\gld	 //
...
\FIXME{Figure this out. Looks like too many negatives, and there’s maybe something missing?}
...
Because this is a very common and well documented word, the form in (\lastx) is given as \fm{sʼíxʼ} with the assumption that \citeauthor{swanton:1909}’s transcription is incorrect.
...
\begingl
	...
	\glpreamble	Hasdu tláa hasdu x̱ánáx̱ daak uwagút. //
	\gla	{} \rlap{Hasdu} @ {} tláa {}
		{} \rlap{hasdu} @ {} \rlap{x̱ánáx̱} @ {} {}
		daak @ \rlap{uwagút.} @ {} @ {} @ {} //
	\glb	{} has= du tláa {}
		{} has= du x̱án -x̱ {}
		dáak= u- i- \rt[¹]{gut} -μH //
