...
The interpretation of \orth{a} as a nonhuman possessor would be consistent with the obviative use of nonhuman pronouns and in this context would presumably refer to the father of the two sisters mentioned in (\ref{ex:92-167-town-start-to-appear}).
...
The interpretation of \orth{a} as a locative PP \fm{áa} ‘there’ is also reasonable, but it feels somewhat out of place because it is another postposition different from the punctual \fm{-t}.
