...
Also two short versions by \fm{Sʼoow Dalé} Minnie Johnson and comment by Emma Ellis \parencite[892–893]{de-laguna:1972}.
Story by Pansy Bailey \parencite[692–695]{mcclellan-cruikshank:2007c} mentions a similar \fm{shaatuḵáawu} and has several similar plot points but it is not exactly the same.}
...
\begingl
	...
	\gld	\phantom{(}now just {} {} {} it -to {}
		...
		{} ancient my \rlap{grandparent\ix{i}} {} {} {} {} //
...
\begingl
	...
	\glpreamble	Shaakanaaÿí hídi, a ÿeet has ÿawduwawooḵ. //
...
The man – \fm{Shaakanaayí} – is in the middle of packing things into the house as described in (\ref{ex:92-117-packing-hunter}).
He pauses in the middle of the doorway, presumably after seeing the girls, and asks his mother the question in (\nextx).
