...
\begingl
	...
	\glpreamble	Tle áwé xʼaandéin adaané du ÿéet kʼátskʼu, dé áa awlixaaji du dláakʼ. //
	\gla	Tle \rlap{áwé} @ {}
		\rlap{xʼaandéin} @ {} @ {}
		\rlap{adaané} @ {} @ {} @ {}
	...
	\gld	then \rlap{it.is} {}
		...
		{} {} already {} them -on {}
			\rlap{\xx{ncnj}.\xx{pfv}.give·up} {} {} {} {} {} -whom {}
			his sister {} //
	\glft	‘Then she acts angrily to her young boy son, his sisters whom he had already given up on.’
		//
\endgl
\xe

\citeauthor{swanton:1909}’s interpretation of \fm{awlixaach} in (\lastx) is wrong.
He takes it to mean ‘longed for’ when it actually means ‘gave up on, despaired of’.
The subject of this verb is not entirely clear, but it is most likely the son and not the mother.
This is suggested by the use of the noun \fm{dláakʼ} ‘sister’ rather than \fm{sée} ‘daughter’.

\FIXME{What if subordinate \fm{awlixaají} rather than relative \fm{awlixaaji}?
Then this would be an adjunct clause rather than a dangling DP.}
