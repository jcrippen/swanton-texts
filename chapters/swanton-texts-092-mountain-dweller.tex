...
It could be a mistranscription of \fm{wooyeiḵ} which is a grammatical form. 
Alternatively, the unusual pronunciation with [\ipa{h}] could be the performance of an otherwise unknown archaic speech style or perhaps the imitation of an elderly woman with a large labret impeding her ability to articulate labials.
...
The root thus has a basic meaning of ‘bite’ and an extended meaning ‘carry in mouth’ as a handling verb, distinguished from the basic meaning by the addition of motion derivations.
...
The phrase in (\next) has a DP \fm{hasdu x̱ʼa.eetí} preceding a focus particle \fm{sáyú} which normally only happens at the left edge of a sentence.
...
\begingl
	...
	\glpreamble	Hasdu x̱ʼa.eetí sáyú daak kawdudzi.aat. //
	\gla	{} \rlap{Hasdu} @ {} \rlap{x̱ʼa.eetí} @ {} {}
		\rlap{sáyú} @ {} @ {}
		daak @ \rlap{kawdudzi.aat.} @ {} @ {} @ {} @ {} @ {} @ {} @ {} //
	\glb	{} has= du x̱ʼé- eetí {}
		s= á -yú
		dáak= k- wu- du- d- s- i- \rt[¹]{.at} -μμL //
	...
	\gld	{} \rlap{their} {} \rlap{leavings} {} {}
		maybe\· \rlap{it.is} {}
		out \rlap{\xx{ncnj}.\xx{pfv}.ppl.handle·\xx{pl}} {} {} {} {} {} {} {} //
...
This is because the \fm{s-} is normally used for either a simple causative like \fm{has awsi.aat} ‘s/he made them go’ and \fm{has ajiwsi.aat} ‘s/he sent them to fight’ or otherwise for the unique verb describing a creature (e.g.\ insect) crawling like \fm{kawsi.aat} ‘it crawled’%
\footnote{Examples of this obscure verb include
\fm{a kanax̱ kansi.aat} “ants walking across”,
\fm{a káx̱ kawsi.aat} “(gumboots) are moving around on a rock”;
...
The \fm{l-} is much more widespread in its use for verbs that describe the position or handling of plural objects \parencites[02/79–95]{leer:1973}[92–96]{leer:1976}.
The context in (\lastx) appears to involve handling, but \citeauthor{swanton:1909}’s transcription of \orth{ka′odudziāt} unambiguously indicates \fm{dzi} rather than \fm{dli} and thus \fm{s-} not \fm{l-}.

The other unusual feature of the verb in (\lastx) is its stem variation.
\citeauthor{swanton:1909} has the stem \orth{āt} which suggests either long low tone \fm{–.aat} [\ipa{ʔàːt}] with \fm{-μμL} or long high tone \fm{–.áat} [\ipa{ʔáːt}] with \fm{-μμH}.
...
But the verb word is preceded by \orth{dāq} which could be either \fm{daak=} ‘out to sea, out into open, falling from sky, onto fire’ or \fm{daaḵ=} ‘inland, back from open, off of fire’ \parencite[297]{leer:1991}.
...
The affirmative main clause \fm{∅}-conjugation class perfective aspect stem for the root \fm{\rt[¹]{.at}} is expected to be the short high tone \fm{–.át} [\ipa{ʔát}].
...
None of these three have any obvious semantic contributions in this context, but the \fm{n}-conjugation menaing of ‘horizontal’ seems to be the least problematic.
Thus the verb in (\lastx) is given as \fm{n}-conjugation, maintaining grammatical compatibility with \citeauthor{swanton:1909}’s transcription although the speaker’s intent here is unclear.