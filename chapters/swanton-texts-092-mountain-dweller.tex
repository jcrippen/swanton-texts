...
Notably, he does not mention any stories from other cultures that bear any close resemblance to the \fm{Shaakanaaÿí} story.

\citeauthor{swanton:1908} offers a photograph of a model for a totem pole which was erected for a \fm{Chookaneidí} clan leader called ”Dāx̣ug̣ē′t” which is probably \fm{Daaxoogeit} \parencite[431 fig.\ 109]{swanton:1908}.
...
At the top of the pole is a bird labelled “kī-dschūk, Habicht [hawk]” which is \fm{gijook} (perhaps from \fm{kích} ‘wing’ + \fm{\rt{yuʼk}} ‘shake’) that is variously identified as a golden eagle (\textit{Aquila chrysaetos})\ or a kind of hawk (\textit{Accipitrinae} or \textit{Buteoninae}).
\citeauthor{krause:1885} later gives the alternative name “schkā-tā-hīn-āri” \parencites[380]{krause:1885}[251]{krause:1956} which seems to be \fm{Shg̱adaahéen Aaÿí} ‘One of \fm{Shg̱adaahéen}’.
...
\citeauthor{swanton:1908} says that \fm{Shaakanaaÿí} is “said to bring good luck to one who hears him chopping and sees where he has been” \parencite[460]{swanton:1908}.
Following this he suggests that \fm{Shaakanaaÿí} may be the same as \fm{Taxgwás} (“Tᴀxgwᴀ′s”) who is “a being who made canoes”.
This \fm{Taxgwás} appears in \citeauthor{swanton:1908}’s published materials only in this context and in a song by \fm{Sakwéitʼ} of the \fm{Lʼeeneidí} clan \parencite[410–411 \#82]{swanton:1909}.
...
\citeauthor{swanton:1908} claims that the Tlingit \fm{Taxgwás} corresponds to the Haida “Wᴀtg̣adagā′ñ” whom \citeauthor{enrico:2005} gives as Skidegate Haida \fm{7w@t radagaang} [\ipa{ʔwat qatakaːŋ}] or Masset Haida \fm{ru ratʼagang} [\ipa{ʔˤu ʔˤatʼakaŋ}] \parencite[1623]{enrico:2005}.
...
\citeauthor{paul:1944}’s connection of this story to the \fm{G̱aanax̱teidí} clan might seem to be incompatible with \citeauthor{swanton:1909}’s information that \fm{Shaakanaaÿí} was a member of the \fm{Chookaneidí} clan since the \fm{G̱aanax̱teidí} are Raven moiety and the \fm{Chookanedí} are Wolf/Eagle moiety \parencites[399–400]{swanton:1908}[436]{emmons:1991}.
But the story always describes at least one of the two sisters as being married to \fm{Shaakanaaÿí}.
Furthermore, that the baskets are said to be made by the sisters and not by \fm{Shaakanaaÿí} himself.
