...
\lingset{%
	...
	extraglskip=0.5ex,
	% Amount of hanging indent for n>1 gloss lines.
	glhangindent=1em,
	% Type of hanging indent: none, normal, cascade
	glhangstyle=none,
	% Vertical skip above an \ex ... \xe (whole example).
	aboveexskip=0.4375em plus 0.375em minus 0.375em,
	% Vertical skip below an \ex ... \xe (whole example).
	belowexskip=0.4375em plus 0.375em minus 0.375em,
